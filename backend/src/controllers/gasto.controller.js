...
// Obtención de gastos por ID de usuario. ELIMINAR.
export const getGastosByUser = async (req, res) => {
  try {
    ...
    // Asegúrate de que el filtro usa ObjectId
    ...
    console.error("Error al obtener gastos por usuario:", error);
    res.status(500).json({ message: "Error interno del servidor" });
  }
};
